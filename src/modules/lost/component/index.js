...
class EditNews extends React.Component {
  ...
  render() {
  	let { editorState_1, editorState_2, editorState_3, editorState_4, editorState_5, fileList, loading, submitLoading } = this.state;
		        ...
		        <div className="ibox-content">
		    		<ZZEditor editorState={editorState_1} companyId={'1'} saveEditorState={this.saveEditorState} />
	  				...
	  				<div style={{textAlign: 'center'}}>
			    		<Button type="primary" loading={this.state.submitLoading} onClick={this.submitLost.bind(null, '1')}>
				        	确认
				        </Button>
				    </div>
			    </div>
	    	...
	    	<Col span={8}>
		        ...
		        <div className="ibox-content">
		    		<ZZEditor editorState={editorState_2} companyId={'2'} saveEditorState={this.saveEditorState} />
      				<Divider></Divider>
      				<div style={{textAlign: 'center'}}>
			    		<Button type="primary" loading={this.state.submitLoading} onClick={this.submitLost.bind(null, '2')}>
				        	确认
				        </Button>
				    </div>
			    </div>
	    	...
	    	<Col span={8}>
		        ...
		        <div className="ibox-content">
		    		<ZZEditor editorState={editorState_3} companyId={'3'} saveEditorState={this.saveEditorState} />
      				<Divider></Divider>
      				<div style={{textAlign: 'center'}}>
			    		<Button type="primary" loading={this.state.submitLoading} onClick={this.submitLost.bind(null, '3')}>
				        	确认
				        </Button>
				    </div>
			    </div>
	    	...
	    	<Col span={8}>
		        ...
		        <div className="ibox-content">
		    		<ZZEditor editorState={editorState_4} companyId={'4'} saveEditorState={this.saveEditorState} />
	  				<Divider></Divider>
	  				<div style={{textAlign: 'center'}}>
			    		<Button type="primary" loading={this.state.submitLoading} onClick={this.submitLost.bind(null, '4')}>
				        	确认
				        </Button>
				    </div>
			    </div>
	    	...
	    	<Col span={8}>
		        ...
		        <div className="ibox-content">
		    		<ZZEditor editorState={editorState_5} companyId={'5'} saveEditorState={this.saveEditorState} />
      				<Divider></Divider>
      				<div style={{textAlign: 'center'}}>
			    		<Button type="primary" loading={this.state.submitLoading} onClick={this.submitLost.bind(null, '5')}>
				        	确认
				        </Button>
				    </div>
			    </div>
