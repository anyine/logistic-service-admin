...
class AddHealthLife extends React.Component {
    constructor(props) {
        super(props);
            ...
            if (!err) {
                ...
                ajax.postJSON(saveHealthUrl, JSON.stringify(values), (data) => {
                    if(data.success){
                        ...
                        this.context.router.push('/frame/dish/healthLife');
                    }
                });
            }
        });
...
const WrappedAddHealthLife = Form.create()(AddHealthLife);
AddHealthLife.contextTypes = {
    router:React.PropTypes.object
}

export default WrappedAddHealthLife;
